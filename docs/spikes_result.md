...
## Deferred (need external credentials — run in Loop 4 pre-flight)

- **Spike 1** — Slack 3s ack (needs Slack workspace) → Epic 4
- **Spike 2** — OpenAI Assistants POLL (needs OpenAI key) → Epic 5
